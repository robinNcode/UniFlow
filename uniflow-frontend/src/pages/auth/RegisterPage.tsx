  ...
  return (
    <div className="max-w-md mx-auto pt-6 md:pt-14 pb-10 animate-fade-in">
      <div className="text-center mb-6">
        ...
        <p className="text-slate-500 text-sm mt-1">Takes about a minute. You'll use your phone number to log in.</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-surface border border-slate-200 rounded-xl p-6 space-y-4" noValidate>
        ...
        <div>
          <Input
            ...
            required
          />
          <p className="text-xs text-slate-400 mt-1">Accepts 01XXXXXXXXX or +8801XXXXXXXXX format.</p>
        </div>
